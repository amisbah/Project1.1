...
def show_song(inp="Winner"):  # default winner ... but also could be something
    # else if it works correctly, which it does not (put in description
    # and remove this clarity)
    a = ["win", "winner", "hurrah", "hooray"]
    songs_resp = helper_functions.get_and_cache_songs(random.choice(a))
...
# "https://itunes.apple.com/us/album/bears-adventure/id495954957?
# i=495955054&uo=4" doesn’t understand the “open location” message. (-1708)
